...
- **Y. Nabou**, [Ion Necoara](https://acse.pub.ro/index.php/en/ion-necoara/), *Moving higher-order Taylor approximations method for smooth constrained minimization problems*, [arXiv](https://arxiv.org/abs/2402.15022), *SIAM Journal on Optimization (SIOPT)*, accepted, 2025.   
