...
- **Y. Nabou**, [Ion Necoara](https://acse.pub.ro/index.php/en/ion-necoara/), *Moving higher-order Taylor approximations method for smooth constrained minimization problems*, *SIAM Journal on Optimization (SIOPT)*, [arXiv](https://arxiv.org/abs/2402.15022).   
